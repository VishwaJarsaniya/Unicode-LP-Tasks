...
import women from "../pics/women.png";
import women2 from "../pics/women2.png";
import Aos from "aos";
  ...
  return (
      ...
      <Card style={{borderRadius:'0px' , border:'none'}}>
        <CardContent>
          <Grid container>
          <Grid item>
              <img src={women} style={{width:'600px', height:'500px', marginTop:'10%', marginLeft:'20%', marginBottom:'5%'}}/>
            </Grid>
            <Grid item>
              <img src={women2} style={{width:'300px', marginTop:'25%', marginLeft:'75%'}} />
              <Button  variant="contained" style={{border:'8px',borderColor:'black',background:'#000000',borderRadius:'0px',padding:'15px', marginTop:'5%', marginLeft:'90%'}}>
                View Collection
              </Button>
            </Grid>
          </Grid>
